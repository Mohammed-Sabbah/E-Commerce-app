        ...
        <div className={`${className}`}>
            ...
            <div className='pt-3 '>
                ...
                <div className='flex gap-2 items-center py-2 px-1'>
                    <input type="radio" name="color" className=' appearance-none bg-amber-600 w-5 h-5 rounded-full cursor-pointer checked:ring-2 checked:ring-black checked:ring-offset-2 checked:w-3 checked:h-3' />
                    <input type="radio" name="color" className='appearance-none bg-amber-200 w-5 h-5 rounded-full cursor-pointer checked:ring-2 checked:ring-black checked:ring-offset-2 checked:w-3 checked:h-3' />
                </div>
            </div>
